# test\runtests.jl
using Test # Hinzugefügt, um @testset zu definieren
...
@testset "NonlinearOptimizationTestFunctionsInJulia Tests" begin
 ...
 @test NonlinearOptimizationTestFunctionsInJulia.ROSENBROCK_FUNCTION.start ≈ [0.0, 0.0]
 @test NonlinearOptimizationTestFunctionsInJulia.ROSENBROCK_FUNCTION.name == "Rosenbrock"
 @test NonlinearOptimizationTestFunctionsInJulia.ROSENBROCK_FUNCTION.info[:description] == "Rosenbrock function: f(x) = Σ 100(x_{i+1} - x_i^2)^2 + (1 - x_i)^2"
 ...
 @test NonlinearOptimizationTestFunctionsInJulia.ROSENBROCK_FUNCTION.min_position ≈ [1.0, 1.0]
 @test NonlinearOptimizationTestFunctionsInJulia.ROSENBROCK_FUNCTION.min_value ≈ 0.0
 ...
 @test NonlinearOptimizationTestFunctionsInJulia.SPHERE_FUNCTION.start ≈ [0.0, 0.0]
 @test NonlinearOptimizationTestFunctionsInJulia.SPHERE_FUNCTION.name == "Sphere"
 @test NonlinearOptimizationTestFunctionsInJulia.SPHERE_FUNCTION.info[:description] == "Sphere function: f(x) = Σ x_i^2"
 ...
 @test NonlinearOptimizationTestFunctionsInJulia.SPHERE_FUNCTION.min_position ≈ [0.0, 0.0]
 @test NonlinearOptimizationTestFunctionsInJulia.SPHERE_FUNCTION.min_value ≈ 0.0
